 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.fintech.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.fintech'; // ios bundle id
const PACKAGE = 'com.fintech'; // android package name
const NAME = 'fintech'; // app name
const EXPO_ACCOUNT_OWNER = 'divineleo2001-org'; // expo account owner
const EAS_PROJECT_ID = '027aba0c-cd1a-4ba3-906b-fc2d2e4bad52'; // eas project id
const SCHEME = 'fintech'; // app scheme
